...
!(function (a) {
    ...
    var Pa = (a.fullCalendar = { version: "2.5.0", internalApiVersion: 1 }),
      Qa = (Pa.views = {});
    ...
    kb.mixin({
      ...
      listenToExternalDrag: function (a, b, c) {
        var d,
          ...
          i = new ib(this, {
            ...
            hitOver: function (a) {
              (d = e.computeExternalDrop(a.component.getHitSpan(a), f)),
                d ? e.renderDrag(d) : g();
            },
            hitOut: function () {
      ...
      computeExternalDrop: function (a, b) {
        ...
        return (
          ...
          c.isExternalSpanAllowed(this.eventToSpan(d), d, b.eventProps) ? d : null
        );
      },
          ...
          a.each(e, function (a, b) {
            ...
            if (xa(b[0]))
              for (g = d.invertRanges(g), e = 0; e < g.length; e++)
                d.generateEventSegs(g[e], b[0], c, f);
            else
              for (e = 0; e < g.length; e++)
                d.generateEventSegs(g[e], b[e], c, f);
          }),
          f
        );
      },
      ...
      generateEventSegs: function (a, b, c, d) {
        var e, f;
        for (
          this.transformEventSpan(a, b), e = c ? c(a) : this.spanToSegs(a), f = 0;
          f < e.length;
          f++
        )
          this.transformEventSeg(e[f], a, b), d.push(e[f]);
      },
      transformEventSpan: function (a, b) {},
      transformEventSeg: function (a, b, c) {
        (a.event = c),
          (a.eventStartMS = +b.start),
          (a.eventDurationMS = b.end - b.start);
      },
    ...
    var lb = (Pa.DayTableMixin = {
        ...
        renderBgCellHtml: function (a) {
          ...
          return (
            c.unshift("fc-day", b.widgetContentClass),
            '<td class="' +
              c.join(" ") +
              '" data-date="' +
              a.format("YYYY-MM-DD") +
    ...
    var nb = (Pa.TimeGrid = kb.extend(lb, {
      ...
      renderHelper: function (b, c) {
        var d,
          ...
          f,
          g,
          h = this.eventToSegs(b);
        for (
          h = this.renderFgSegEls(h), d = this.renderSegTable(h), e = 0;
          e < h.length;
          e++
        )
          (f = h[e]),
    ...
    nb.mixin({
      ...
      renderSegTable: function (b) {
        var c,
          ...
          j = i.find("tr");
        for (
          c = this.groupSegCols(b), this.computeSegVerticals(b), f = 0;
          f < c.length;
          f++
        ) {
          for (
