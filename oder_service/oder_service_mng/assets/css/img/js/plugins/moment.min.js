...
(function (a) {
    ...
    function kb(a, b, c, d, e) {
      ...
      return (
        ...
        (g = 7 * (b - 1) + (c - e) + f + 1),
        { year: g > 0 ? a : a - 1, dayOfYear: g > 0 ? g : F(a - 1) + g }
      );
    }
    function lb(b) {
      var c,
    ...
    (rc.DDDD = h(rc.DDD, 3)),
      o(l.prototype, {
        ...
        _weekdaysShort: "Chủ nhật_Thứ 2_Thứ 3_Thứ 4_Thứ 5_Thứ 6_Thứ 7".split("_"),
