    ...
    for (var e in d.paths) {
      ...
      f.setFill(this.color),
        ...
        "svg" === this.canvas.mode
          ? f.setAttribute("class", "jvectormap-region")
          : jQuery(f).addClass("jvectormap-region"),
      ...
      jQuery(a.container).delegate(
        ...
        function (b) {
          if (!a.multiSelectRegion)
            for (var e in d.paths)
              (c.countries[e].currentFillColor =
                c.countries[e].getOriginalFill()),
                c.countries[e].setFill(c.countries[e].getOriginalFill());
          var f = b.target,
            g = b.target.id.split("_").pop(),
            h = jQuery.Event("regionClick.jqvmap");
          (g = g.toLowerCase()),
            jQuery(a.container).trigger(h, [g, d.paths[g].name]),
            h.isDefaultPrevented() ||
              (c.isSelected(g) ? c.deselect(g, f) : c.select(g, f));
        }
      ),
      a.showTooltip &&
                ...
                e.length > 0 && e.remove(),
                  c.container.append(
                    '<div id="' +
                      ...
                      '" for="' +
                      a +
                      '" class="jqvmap_pin" style="position:absolute">' +
                      b +
                      "</div>"
                  );
              }
                ...
                e.length > 0 && e.remove(),
                  c.container.append(
                    '<div id="' +
                      ...
                      '" for="' +
                      a +
                      '" class="jqvmap_pin" style="position:absolute"></div>'
                  ),
                  e.append(jQuery("#" + b));
              }
            }),
